...
#Footer
st.markdown("---")
st.markdown("""<p style= 'text-align: center;' >Powered by <b>Streamlit</b> and <b>Google Gemini AI</b> | target="_blank" style='text-decoration: none; color: #FFFFFF'></a></p>""", unsafe_allow_html=True)